...
export default function SolutionsContent() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "linear-gradient(180deg, #00FFFF 0%, #0066FF 100%)",
      color: "#000000",
      position: "relative",
      zIndex: 3,
    }}>
      ...
      <section style={{ paddingTop: 140, paddingBottom: 60, textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          <div style={{
            ...
            fontSize: 12, fontFamily: "'DM Mono', monospace", color: "#000",
          ...
          <h1 style={{
            ...
            fontWeight: 800, lineHeight: 1.1, margin: "0 0 20px", color: "#000",
          }}>
            Built for Your Industry.{" "}
            <span style={{ display: "block" }}>Powered by AI.</span>
          </h1>
          <p style={{
            fontFamily: "'DM Sans', sans-serif", fontSize: 18, color: "rgba(0,0,0,0.7)",
          ...
          {INDUSTRIES.map((ind) => (
            <a
              ...
              style={{
                ...
                background: activeIndustry === ind.slug ? "rgba(255,255,255,0.35)" : "rgba(255,255,255,0.2)",
                border: `1px solid ${activeIndustry === ind.slug ? "rgba(0,0,0,0.2)" : "rgba(0,0,0,0.08)"}`,
                color: "#000",
                fontSize: 13, fontFamily: "'DM Sans', sans-serif",
                fontWeight: activeIndustry === ind.slug ? 700 : 500,
            ...
            <div key={ind.slug} id={ind.slug} style={{ scrollMarginTop: 100 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
                <div style={{
                  ...
                  background: "rgba(255,255,255,0.25)", border: "1px solid rgba(0,0,0,0.1)",
                  display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28,
                }}>
                  {ind.icon}
                </div>
                <div>
                  <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 28, fontWeight: 800, color: "#000", margin: 0 }}>
                    {ind.title}
                  </h2>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "rgba(0,0,0,0.7)", margin: "4px 0 0", fontWeight: 600 }}>
                    {ind.tagline}
                  </p>
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 24 }}>
                {[
                  ...
                  <div key={s.label} style={{
                    background: "rgba(255,255,255,0.2)", border: "1px solid rgba(0,0,0,0.08)",
                    borderRadius: 12, padding: "18px 20px", textAlign: "center",
                    backdropFilter: "blur(8px)",
                  }}>
                    <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 24, fontWeight: 800, color: "#000" }}>{s.value}</div>
                    <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "rgba(0,0,0,0.55)", letterSpacing: 1.5, textTransform: "uppercase", marginTop: 4 }}>{s.label}</div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "rgba(0,0,0,0.55)", letterSpacing: 2, textTransform: "uppercase", marginBottom: 16 }}>
                    Industry Challenges
                  </div>
                  {ind.challenges.map((c, i) => (
                    <div key={i} style={{ display: "flex", gap: 10, marginBottom: 12, alignItems: "flex-start" }}>
                      <span style={{ color: "#cc0000", fontSize: 14, marginTop: 2, flexShrink: 0, fontWeight: 700 }}>✕</span>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "rgba(0,0,0,0.8)", lineHeight: 1.6 }}>{c}</span>
                    </div>
                  ))}
                </div>
                ...
                {/* Solutions */}
                <div style={{
                  background: "rgba(255,255,255,0.22)", border: "1px solid rgba(0,0,0,0.1)",
                  borderRadius: 14, padding: 24, backdropFilter: "blur(8px)",
                }}>
                  <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "rgba(0,0,0,0.6)", letterSpacing: 2, textTransform: "uppercase", marginBottom: 16, fontWeight: 600 }}>
                    How SIGNAL Solves It
                  </div>
                  {ind.solutions.map((s, i) => (
                    <div key={i} style={{ display: "flex", gap: 10, marginBottom: 12, alignItems: "flex-start" }}>
                      <span style={{ color: "#006600", fontSize: 14, marginTop: 2, flexShrink: 0, fontWeight: 700 }}>✓</span>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#000", lineHeight: 1.6 }}>{s}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginTop: 16 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 40, fontWeight: 800, color: "#000", marginBottom: 4 }}>
                    {ind.caseStudy.metric}
                  </div>
                  <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 700, color: "#000", marginBottom: 8 }}>
                    {ind.caseStudy.label}
                  </div>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "rgba(0,0,0,0.65)", lineHeight: 1.6, margin: 0 }}>
                ...
                <div style={{
                  ...
                  {ind.tools.map((t) => (
                    <Link key={t.href} href={t.href} style={{
                      ...
                      background: "rgba(255,255,255,0.15)", border: "1px solid rgba(0,0,0,0.06)",
                      textDecoration: "none", transition: "all 0.2s",
                    }}>
                      <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#000", fontWeight: 500 }}>{t.name}</span>
                      <span style={{ color: "rgba(0,0,0,0.4)", fontSize: 16 }}>→</span>
                    </Link>
                  ))}
                  <Link href="/tools" style={{
                    display: "block", textAlign: "center", marginTop: 12,
                    fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#000", fontWeight: 700,
      ...
      <section style={{ padding: "80px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 32, fontWeight: 800, color: "#000", marginBottom: 16 }}>
            Ready to dominate your industry?
          </h2>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, color: "rgba(0,0,0,0.7)", lineHeight: 1.7, marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 12 }}>
            ...
            <Link href="/tools" style={{
              ...
              border: "1px solid rgba(0,0,0,0.15)", textDecoration: "none",
            }}>
              Try Free Tools
            </Link>
          </div>
      ...
      {/* ─── FOOTER ──────────────────────────────────────── */}
      <footer style={{ borderTop: "1px solid rgba(0,0,0,0.1)", padding: "40px 24px", textAlign: "center" }}>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "rgba(0,0,0,0.5)" }}>
