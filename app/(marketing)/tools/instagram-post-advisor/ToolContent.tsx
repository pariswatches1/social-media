        ...
        {result?.success && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 16 }}>
              {/* Best Posting Times */}
              <div style={{ background: "rgba(255,255,255,0.2)", border: "1px solid rgba(10,30,94,0.12)", borderRadius: 12, padding: 18 }}>
            ...
            {result.recommendations && (
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                {result.recommendations.map((rec: any, i: number) => (
                  <div key={i} style={{ background: "rgba(255,255,255,0.2)", border: "1px solid rgba(10,30,94,0.12)", borderRadius: 12, padding: 20 }}>
            ...
            {result.captionAnalysis && (
              <div style={{ background: "rgba(255,255,255,0.2)", border: "1px solid rgba(10,30,94,0.12)", borderRadius: 12, padding: 20, marginTop: 16 }}>
