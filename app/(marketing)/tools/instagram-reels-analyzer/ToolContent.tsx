          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 16 }}>
              <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 18, textAlign: "center" }}>
                <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>Reels Count</div>
                <div style={{ fontSize: 28, fontWeight: 800, fontFamily: "'Syne', sans-serif", color: "#e2e8f0" }}>{result.reelsCount ?? "—"}</div>
              </div>
              <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 18, textAlign: "center" }}>
                <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>% of Total</div>
                <div style={{ fontSize: 28, fontWeight: 800, fontFamily: "'Syne', sans-serif", color: "#06b6d4" }}>{result.reelsPercentage?.toFixed(1) ?? "—"}%</div>
              </div>
              <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 18, textAlign: "center" }}>
                <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>Avg Plays</div>
            ...
            <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 20, marginBottom: 16 }}>
              <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 16 }}>Engagement: Reels vs Overall</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                ...
                <div style={{ padding: 16, borderRadius: 10, background: "rgba(148,163,184,0.06)", border: "1px solid rgba(148,163,184,0.15)", textAlign: "center" }}>
                  <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#94a3b8", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>Overall Engagement</div>
                  <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "'Syne', sans-serif", color: "#94a3b8" }}>{result.overallEngagement?.toFixed(2) ?? "—"}%</div>
                </div>
              </div>
            ...
            {result.topReels && result.topReels.length > 0 && (
              <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 20 }}>
                <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 14 }}>Top 3 Reels</div>
                {result.topReels.slice(0, 3).map((reel: any, i: number) => (
                  <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 0", borderBottom: i < 2 ? "1px solid #1e2535" : "none" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontFamily: "'DM Sans', sans-serif", color: "#e2e8f0", marginBottom: 2 }}>{reel.caption || "Reel"}</div>
                        <div style={{ fontSize: 11, fontFamily: "'DM Mono', monospace", color: "#4a5568" }}>{reel.date}</div>
                      </div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontSize: 14, fontWeight: 700, fontFamily: "'Syne', sans-serif", color: "#e2e8f0" }}>{reel.plays?.toLocaleString()} plays</div>
