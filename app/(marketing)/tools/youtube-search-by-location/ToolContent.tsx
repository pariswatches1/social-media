        ...
        {result?.success && result.channels && (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            {result.regionalInsights && (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 4 }}>
                <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 16 }}>
                  <div style={{ fontSize: 10, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>Dominant Language</div>
                  <div style={{ fontSize: 16, fontWeight: 700, fontFamily: "'Syne', sans-serif", color: "#e2e8f0" }}>{result.regionalInsights.dominantLanguage}</div>
                </div>
                <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 16 }}>
                  <div style={{ fontSize: 10, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>Popular Categories</div>
            ...
            {result.regionalInsights?.marketNotes && (
              <div style={{ background: "#0a0d14", border: "1px solid #1e2535", borderRadius: 12, padding: 16, marginBottom: 4 }}>
                <div style={{ fontSize: 10, fontFamily: "'DM Mono', monospace", color: "#4a5568", letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 }}>Market Notes</div>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#94a3b8", margin: 0, lineHeight: 1.5 }}>{result.regionalInsights.marketNotes}</p>
              </div>
            )}
