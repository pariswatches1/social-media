...
export default function ToolContent() {
  ...
  const getTierColor = (tier: string) => {
    ...
    if (t.includes("mid")) return "#0a1e5e";
    if (t.includes("rising")) return "#166534";
    return "#b45309";
  };
        ...
        {result?.success && (
          <div>
            ...
            <div style={{ background: "rgba(10,30,94,0.1)", border: "1px solid rgba(10,30,94,0.12)", borderRadius: 12, padding: 28, textAlign: "center", marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 52, fontWeight: 800, fontFamily: "'Syne', sans-serif", color: "#0a1e5e" }}>
                  ...
                  return (
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                        ...
                        <span style={{ fontSize: 12, fontFamily: "'DM Mono', monospace", color: "#0a1e5e" }}>{formatNum(next)}</span>
                      </div>
                      <div style={{ height: 8, borderRadius: 4, background: "rgba(10,30,94,0.08)" }}>
                        <div style={{ height: 8, borderRadius: 4, background: "linear-gradient(90deg, #1e40af, #1d4ed8)", width: `${progress}%`, transition: "width 0.5s ease" }} />
                      </div>
                    </div>
                  );
                })()}
